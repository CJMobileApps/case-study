 ...
 * otherwise false
 */
fun String.validateCreditCard(): Boolean {
    val creditCardNumber: String = this
    if (creditCardNumber.length < 13 || creditCardNumber.length > 19) return false
